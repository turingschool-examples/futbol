...
class SeasonStatisticsTest <Minitest::Test
  ...
  def test_total_shots_by_team
    ...
    assert_equal 779, @stat_tracker.total_shots_by_team('20132014', '16')
    assert_equal 571, @stat_tracker.total_shots_by_team('20132014', '15')
  end

  def test_total_goals_by_team

    assert_equal 237, @stat_tracker.total_goals_by_team('20132014', '16')
    assert_equal 161, @stat_tracker.total_goals_by_team('20132014', '15')
  end

  def test_team_accuracy

    assert_equal 0.270073, @stat_tracker.team_accuracy("20132014")['3']
    assert_equal 0.334776, @stat_tracker.team_accuracy("20132014")['24']
  end
end
