...
class TestStatTracker < Minitest::Test
  ...
  def test_stat_tracker_can_pull_file_locations
    assert_equal 7_441, @stat_tracker.games.length
    assert_equal 32, @stat_tracker.teams.length
    assert_equal 14_882, @stat_tracker.game_teams.length
  end
  ...
  def test_it_has_data
    ...
    assert_equal 41.5, @stat_tracker.game_teams[14_028].faceOffWinPercentage
  end
