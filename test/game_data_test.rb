...
class GameDataTest < Minitest::Test
  ...
  def test_highest_total_score_in_game
    assert_equal 5, @game_data.highest_total_score_in_game
  end
##Edgecase for multiple highest scores - array?
  ...
  def test_percentage_home_wins
    assert_equal 0.56, @game_data.percentage_home_wins
  end
  ...
  def test_percentage_visitor_wins
    assert_equal 0.44, @game_data.percentage_visitor_wins
  end
end
