...
class GameStatsCollectionTest < Minitest::Test
  ...
  def test_average_goals_by_team_id
    ...
    result2 = {3=>1.67, 6=>3.0}
    assert_equal result2, @game_stats_collection.average_goals_by_team_id("away")

    result = {6 => 3.00, 3 => 1.50, 5 => 0}
    assert_equal result, @game_stats_collection.average_goals_by_team_id("home")
  end
  ...
  def test_find_team_id
    ...
    assert_equal 6, @game_stats_collection.find_team_id("away", "max")
    assert_equal 6, @game_stats_collection.find_team_id("home", "max")
    assert_equal 3, @game_stats_collection.find_team_id("away", "min")
    assert_equal 5, @game_stats_collection.find_team_id("home", "min")
  end
