...
RSpec.describe GameStatistics do
  before(:each) do
    mock_game_1 = OpenStruct.new({ home_score: 1, away_score: 3, total_score: 4, home_win?: false, visitor_win?: true,
                                   tie?: false })
    mock_game_2 = OpenStruct.new({ home_score: 2, away_score: 6, total_score: 8, home_win?: false, visitor_win?: true,
                                   tie?: false })
    mock_game_3 = OpenStruct.new({ home_score: 3, away_score: 1, total_score: 4, home_win?: true, visitor_win?: false,
                                   tie?: false })
    mock_game_4 = OpenStruct.new({ home_score: 2, away_score: 2, total_score: 4, home_win?: false,
                                   visitor_win?: false, tie?: true })
