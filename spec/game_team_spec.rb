...
describe GameTeam do
  ...
  describe '#initialize' do
    ...
    it 'has attributes' do
      ...
      expect(@test_game_teams.powerplayopportunities).to eq("3")
      expect(@test_game_teams.powerplaygoals).to eq("0")
      expect(@test_game_teams.faceoffwinpercentage).to eq("44.8")
      expect(@test_game_teams.giveaways).to eq("17")
      expect(@test_game_teams.takeaways).to eq("7")
    end
  end
end
