...
RSpec.describe Game do
  ...
  let(:game) {Game.new(game_csv_row)}
  ...
  it "has readable hash attributes for away_team and home_team information" do
    game.import_away_team_data(["2012030221", "3", "away", "LOSS", "OT", "John Tortorella", "2", "8", "44", "8", "3", "0", "44.8", "17", "7"])
    game.import_home_team_data(["2012030221", "6", "home", "WIN", "OT", "Claude Julien", "3", "12", "51", "6", "4", "1", "55.2", "4", "5"])
