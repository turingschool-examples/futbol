  ...
  describe 'best_offense and worst_offense' do
    ...
    describe 'least_accurate_team and most_accurate_team' do
      it 'least_accurate_team(20122013)' do
        ...
        expect(@teams.team_name[index]).to eq("New York City FC")
        ...
        expect(@teams.team_name[index]).to eq("Columbus Crew SC")
        ...
        expect(@teams.team_name[index]).to eq("North Carolina Courage")
        ...
        expect(@teams.team_name[index]).to eq("Toronto FC")
      ...
      it 'most_accurate_team' do
        ...
        expect(@teams.team_name[index]).to eq("DC United")
        ...
        expect(@teams.team_name[index]).to eq("Real Salt Lake")
        ...
        expect(@teams.team_name[index]).to eq("Portland Thorns FC")
    ...
    describe 'most_tackles and least_tackles' do
      it 'most_tackles' do
        ...
        expect(@teams.team_name[index]).to eq("FC Cincinatti")
      end
    end
  end
end