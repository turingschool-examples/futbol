...
RSpec.describe StatTracker do
  ...
  before(:each) do
    ...
    # Should these have stat_tracker inside apostrophes?
    @game_list = GameList.new('./data/games_subset.csv', 'stat_tracker')
    @team_list = TeamList.new('./data/teams_subset.csv', 'stat_tracker')
    @game_team_list = GameTeamList.new('./data/game_teams_subset.csv', 'stat_tracker')
  end
