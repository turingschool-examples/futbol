...
describe StatTracker do
  ...
  xit "can calculate the lowest average of an array in an array of team_id, average" do #helper method
    average = [["3", 2.1], ["6", 2.28], ["16", 2.23], ["5", 2.39], ["8", 2.08]]
    expect(@stat_tracker.minimum(average)).to eq(["8", 2.08])
  end

  xit "can calculate the highest average of an array in an array of team_id, average" do #helper method
    average = [["3", 2.1], ["6", 2.28], ["16", 2.23], ["5", 2.39], ["8", 2.08]]
  ...
  xit "can tell which season is a teams worst" do
  ...
  xit "can calculate which team was the lowest scoring visitor" do
    expect(@stat_tracker.lowest_scoring_visitor).to eq "San Jose Earthquakes"
  end

  xit "can calculate which team was the lowest scoring home team" do
    expect(@stat_tracker.lowest_scoring_home_team).to eq "Utah Royals FC"
  end

  xit "can calculate which team has the most tackles in the season" do
    expect(@stat_tracker.most_tackles("20132014")).to eq "FC Cincinnati"
    expect(@stat_tracker.most_tackles("20142015")).to eq "Seattle Sounders FC"
  end

  xit "can calculate which team has the fewest tackles in the season" do
