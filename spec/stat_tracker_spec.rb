...
RSpec.describe StatTracker do 
  ...
  describe '#percentage of wins' do 
    ...
    xit 'can calculate the percentage of ties per season' do 
  ...
  describe '#game averages' do 
    xit 'can determine average goals per game' do 
      expect(@stat_tracker.average_goals_per_game).to eq(4.22)
    end

    xit 'can determine average goals per season' do 
  ...
  describe '#accurate team' do
    xit "names the team with the best ratio of shots to goals per season" do
      expect(@stat_tracker.most_accurate_team("20132014")).to eq "Real Salt Lake"
      expect(@stat_tracker.most_accurate_team("20142015")).to eq "Toronto FC"
    end

    xit "names the team with the worst ratio of shots to goals per season" do
  ...
  describe '#tackles' do
    xit "tracks the team with the most tackles per season" do
      expect(@stat_tracker.most_tackles("20132014")).to eq "FC Cincinnati"
      expect(@stat_tracker.most_tackles("20142015")).to eq "Seattle Sounders FC"
    end

    xit 'tracks the team with the least tackles per season' do 
