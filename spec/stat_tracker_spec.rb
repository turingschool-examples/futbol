...
describe StatTracker do
  ...
  describe '#total_score' do
    xit 'returns the total number of goals' do
  ...
  describe '#highest_total_score' do
    xit 'returns highest sum of the winning and losing teams scores' do
      expect(stat_tracker.highest_total_score).to eq(9)
    end
  end

  describe '#lowest_total_score' do
    xit 'returns lowest sum of the winning and losing teams scores' do
      expect(stat_tracker.lowest_total_score).to eq(1)
    end
  end

  describe '#percentage_home_wins' do
    xit 'returns percentage of wins at home' do
      expect(stat_tracker.percentage_home_wins).to eq(0.50)
    end
  end

  describe '#percentage_visitor_wins' do
    xit 'returns percentage of visitor wins' do
  ...
  describe '#home_games_by_team_id' do
    xit "creates a hash of home games by team id" do
      expect(stat_tracker.home_games_by_team_id).to be_a(Hash)
    end
  end

  describe '#home_goal_avg_per_game' do
    xit "creates a hash of average home goals per game" do
      expect(stat_tracker.home_goal_avg_per_game).to be_a(Hash)
    end
  end

  describe '#average_win_percentage' do
    xit "states avg win percentage of a specific team by team ID" do
      expect(stat_tracker.average_win_percentage("14")).to eq 0.50
    end
  end

  describe '#goals_by_team_id' do
    xit "creates an array of goals per team ID" do
      expect(stat_tracker.goals_by_team_id("14")).to eq([2, 1, 2, 3, 2, 0, 3, 2, 4, 2, 2, 3, 1, 2])
    end
  end

  describe '#most_goals_scored' do
    xit "returns the highest number of goals a team has scored in a single game" do
      expect(stat_tracker.most_goals_scored("14")).to eq 4
    end
  end

  describe '#fewest_goals_scored' do
    xit "returns the lowest number of goals a team has scored in a single game" do
      expect(stat_tracker.fewest_goals_scored("1")).to eq 1
    end
  end
  describe '#team_info' do
    xit 'returns a hash of team_id, franchise_id, team_name, abbreviation, link for a specific team' do
  ...
  describe '#best_season' do
    xit 'Season with the highest win percentage for a team' do
  ...
  describe '#worst_season' do
    xit 'Season with the lowest win percentage for a team' do
  ...
  describe '#count_of_games_by_season' do
    xit 'returns a hash of the number of games(values) per season(keys)' do
      expected_hash = {
        "20122013" => 10,
        "20132014" => 10,
        "20142015" => 10,
  ...
  describe '#average_goals_per_game' do
    xit 'returns the average number of goals per game' do
      expect(stat_tracker.average_goals_per_game).to eq(4.35)
    end
  end

  describe '#average_goals_by_season' do
    xit 'returns a hash of the average goals(values) by season(keys)' do
      expected_hash = {
        "20122013" => 3.90,
        "20132014" => 4.60,
        "20142015" => 4.40,
  ...
  describe '#game_ids_for_season(season)' do
    xit 'collects the game ids for a given season' do
  ...
  describe '#worst_coach(season)' do
    xit 'returns the coach with the worst win' do
  ...
  describe '#season_total_tackles(season)' do
    xit 'returns a hash of total tackles by each team for the season' do
      expected_hash = {
        "15" => 84,
        "54" => 59,
        "14" => 33,
  ...
  describe '#most_tackles(season)' do
    xit 'returns the team name with the most tackles for the season' do
  ...
  describe '#fewest_tackles(season)' do
    xit 'returns the team name with the fewest tackels for the season' do
  ...
  describe '#team_shots_by_season(season)' do
   xit 'returns a hash with the team_id(key) and total shots for the season(value)' do
      expected_hash = {
        '8' => 5,
        '1' => 12,
        '30' => 41,
  ...
  describe '#team_goals_by_season(season)' do
    xit 'returns a hash with the team_id(key) and total goals for the season(value)' do
      expected_hash = {
        '8' => 2,
        '1' => 5,
        '30' => 10,
  ...
  describe '#team_shots_to_goals_ratio(season)' do
    xit 'returns a hash with the team_id(key) and shots-to-goals ratio for the season(value)' do
      expected_hash = {
        '8' => 2.50,
        '1' => 2.40,
        '30' => 4.10,
  ...
  describe '#most_accurate_team' do
    xit 'returns the team with the best ratio of shots to goals for the season' do
      expect(stat_tracker.most_accurate_team("20122013")).to eq("DC United")
    end
  end

  describe '#least_accurate_team' do
    xit 'returns the team with the highest ratio of shots to goals for the season' do
