...
describe StatTracker do
  ...
  describe 'Team Statistics' do
    ...
    #   expect(@stat_tracker.team_wins).to eq(0.0)
    # end

    xit '' do
      expect(@stat_tracker.wins_by_team).to eq(0.0)
    end

    it 'can show season with the average win percentage for a team' do
      expect(@stat_tracker.average_win_percentage(9)).to eq(0.20)
    end
