...
class StatTracker
  ...
  def percentage_home_wins
    ...
    ((home_wins.to_f / games.all.size)*100).round(2)
  end
  ...
  def percentage_visitor_wins
    ...
    ((visitor_wins.to_f / games.all.size)*100).round(2)
  end
  ...
  def percentage_ties
    ...
    ((ties.to_f / games.all.size)*100).round(2)
  end
  ...
  def average_goals_per_game
    ...
    average_goals.to_f / games.all.count
  end
