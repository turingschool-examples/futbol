...
class GameCollection
  ...
  def percentage_home_wins
    ...
    percentage_of_home_wins = home_wins.count.to_f / @games_array.count.to_f * 100
  ...
  def percentage_visitor_wins
    ...
    percentage_of_visitor_wins = visitor_wins.count.to_f / @games_array.count.to_f * 100
  ...
  def percentage_ties
    ...
    percentage_of_ties = ties.count.to_f / @games_array.count.to_f * 100
  ...
  def average_goals_per_game
    ...
    @games_array.each do |game|
      ...
      average_goals_per_game = sum_total_score / (@games_array.count * 2).to_f
