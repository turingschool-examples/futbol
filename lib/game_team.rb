class GameTeam
  attr_reader :game_id, :team_id, :home_or_away, :result,
   ...
   def initialize(raw_data)
    ...
    @home_or_away = raw_data[:home_or_away]
    ...
    @power_play_opportunities = raw_data[:power_play_opportunities].to_i
    @power_play_goals = raw_data[:power_play_goals].to_i
    @face_off_win_percentage = raw_data[:face_off_win_percentage].to_f
