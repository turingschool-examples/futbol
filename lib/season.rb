...
class Season
  ...
  def most_accurate_team(campaign)
      team_name_from_id_average(team_goal_accuracy(campaign).max_by do |coach, percentage| 
        percentage end)
  end

  #Team with the worst ratio of shots to goals for the season
  def least_accurate_team(campaign)
      team_name_from_id_average(team_goal_accuracy(campaign).min_by do |coach, percentage| 
        percentage end)
  end

  def team_goal_accuracy(campaign)
