module LeagueStats
  ...
  def calculate_best_offense
    best_offense = game_manager.team_stats.max_by do |_team, stats|
  ...
  def calculate_worst_offense
    worst_offense = game_manager.team_stats.min_by do |_team, stats|
      stats[:total_goals] / stats[:total_games].to_f
    end
  ...
  def calculate_highest_scoring_visitor
    highest_scoring_visitor = game_manager.team_stats.max_by do |_team, stats|
  ...
  def calculate_highest_scoring_home_team
    highest_scoring_home_team = game_manager.team_stats.max_by do |_team, stats|
  ...
  def calculate_lowest_scoring_visitor
    lowest_scoring_visitor = game_manager.team_stats.min_by do |_team, stats|
      stats[:away_goals] / stats[:away_games].to_f
    end
  ...
  def calculate_lowest_scoring_home_team
    lowest_scoring_home_team = game_manager.team_stats.min_by do |_team, stats|
      stats[:home_goals] / stats[:home_games].to_f
    end
